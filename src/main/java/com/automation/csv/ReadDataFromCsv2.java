...
public class ReadDataFromCsv2 {
	
public static void main(String[] args) {
		
		File csvFile = new File(System.getProperty("user.dir") + "//src//main//resources//CreateUser.csv");
		CsvUtils csvUtils = new CsvUtils();
		 
		List<Map<String, String>> data = csvUtils.readDataFromCsv2(csvFile.getAbsolutePath());
